 ...
 * @return: Boolean
 */
class ePortMessage : LockerPortInterface {
    ...
    private companion object {
        var init: ePortMessage? = null
    }

    init {
        init = this@ePortMessage
    }

    @Throws(TimeoutException::class)
    fun getInit(mAcitvity: Activity, mPATH: String = "/dev/ttyUSB0", BAUDRATE: Int = 9600): ePortMessage {
        activity = mAcitvity
        PATH = mPATH
