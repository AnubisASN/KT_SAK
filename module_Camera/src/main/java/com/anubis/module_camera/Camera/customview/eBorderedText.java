...
public class eBorderedText {
   ...
   */
  public eBorderedText(final float textSize) {
   ...
   * @param textSize text size in pixels
   */
  public eBorderedText(final int interiorColor, final int exteriorColor, final float textSize) {
