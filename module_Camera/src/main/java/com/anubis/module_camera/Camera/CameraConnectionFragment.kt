...
class CameraConnectionFragment private constructor(
    ...
    private fun createCameraPreviewSession() {
        try {
           ...
           eLog("Opening camera preview: " + previewSize!!.width + "x" + previewSize!!.height)
    ...
    companion object {
        ...
        fun chooseOptimalSize(choices: Array<Size?>, width: Int, height: Int): Size {
           ...
           eLog("Desired size: " + desiredSize + ", min size: " + minSize + "x" + minSize)
           eLog("Valid preview sizes: [" + TextUtils.join(", ", bigEnough) + "]")
           eLog("Rejected preview sizes: [" + TextUtils.join(", ", tooSmall) + "]")

            if (exactSizeFound) {
               eLog("Exact size match found.")
                return desiredSize
            }
            ...
            if (bigEnough.size > 0) {
               ...
               eLog("Chosen size: " + chosenSize.width + "x" + chosenSize.height)
                return chosenSize
            } else {
               eLogE("Couldn't find any suitable preview size")
                return choices[0]!!
            }
        }
