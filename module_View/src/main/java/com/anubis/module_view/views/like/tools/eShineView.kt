package com.anubis.module_view.views.like.tools
...
import com.anubis.module_view.animator.eShineAnimator
...
/*闪烁控件*/
class eShineView : View {
    var mRxShineAnimator: eShineAnimator? = null
    var clickAnimator: ValueAnimator? = null
    var mRxShineButton: eShineButtonView? = null
    var colorCount = 10
    ...
    constructor(context: Context?, rxShineButton: eShineButtonView, shineParams: ShineParams) : super(context) {
        initShineParams(shineParams, rxShineButton)
        mRxShineAnimator = eShineAnimator(animDuration, shineDistanceMultiple, clickAnimDuration)
        ...
        clickAnimator?.interpolator = eEasingInterpolator(eEase.QUART_OUT)
        ...
        mRxShineAnimator!!.addListener(object : Animator.AnimatorListener {
            override fun onAnimationStart(animator: Animator) {}
            override fun onAnimationEnd(animator: Animator) {
                rxShineButton.removeView(this@eShineView)
            }
            override fun onAnimationCancel(animator: Animator) {}
            override fun onAnimationRepeat(animator: Animator) {}
        })
    ...
    fun showAnimation(rxShineButton: eShineButtonView?) {
        ...
        mRxShineAnimator!!.eStartAnim(this, centerAnimX, centerAnimY)
        clickAnimator!!.start()
    }
    ...
    private fun initShineParams(shineParams: ShineParams, rxShineButton: eShineButtonView) {
