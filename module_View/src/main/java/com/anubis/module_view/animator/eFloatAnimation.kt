...
/**悬浮动画
 * @param path: Path?,动画路径
 * @param  rotation: Float,旋转
 * @param parent: View,父控件
 * @param  child: View，子控件
 * @return Animation ，动画
* */
class eFloatAnimation(path: Path?, rotation: Float, parent: View, child: View) : Animation() {
