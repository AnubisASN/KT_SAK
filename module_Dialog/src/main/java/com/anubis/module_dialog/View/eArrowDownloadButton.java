package com.anubis.module_dialog.View;
 ...
 */
public class eArrowDownloadButton extends View {
    ...
    private static final float TEXT_SIZE = 55;
    ...
    public eArrowDownloadButton(Context context) {
        this(context, null);
    }

    public eArrowDownloadButton(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.eArrowDownloadButton);
        arcPaintColor = ta.getColor(R.styleable.eArrowDownloadButton_arcPaintColor, BLUE_ONE);
        arrowPaintColor = ta.getColor(R.styleable.eArrowDownloadButton_arrowPaintColor, WHILE);
        smallPaintColor = ta.getColor(R.styleable.eArrowDownloadButton_smallPaintColor, WHILE);
        triPaintColor = ta.getColor(R.styleable.eArrowDownloadButton_triPaintColor, WHILE);
        loadingPaintColor = ta.getColor(R.styleable.eArrowDownloadButton_loadingPaintColor, WHILE);
        textPaintColor = ta.getColor(R.styleable.eArrowDownloadButton_textPaintColor, WHILE);
        textPaintSize = ta.getDimension(R.styleable.eArrowDownloadButton_textPaintSize, textSize);
    }

    public eArrowDownloadButton(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void loading(Canvas canvas) {
        ...
        canvas.drawTextOnPath((int) progress + "%"+hint, textPath, 0, 0, textPaint);
    ...
    protected void initializePaints() {
        ...
        arrowPaint.setColor(arrowPaintColor);
