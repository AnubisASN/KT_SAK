...
public class PhoenixOption implements Parcelable {
    ...
    //是否开启预览按钮显示
    private boolean enableShowPreview = true;
    //是否开启点击预览
    ...
    public boolean isEnableShowPreview() {
        return enableShowPreview;
    }
    ...
    public PhoenixOption enableShowPreview(boolean val) {
        enableShowPreview = val;
        return this;
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeByte(this.enableShowPreview ? (byte) 1 : (byte) 0);
    ...
    protected PhoenixOption(Parcel in) {
        ...
        this.enableShowPreview= in.readByte() != 0;
