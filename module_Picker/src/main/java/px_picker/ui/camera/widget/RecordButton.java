package px_picker.ui.camera.widget;
...
public class RecordButton extends View {
    ...
    void setup() {
        ...
        boundingBoxSize = DeviceUtils.getRealSize(mContext, 100.0F);
        outerCycleWidth = DeviceUtils.getRealSize(mContext, 2.3F);
        outerCycleWidthInc = DeviceUtils.getRealSize(mContext, 3.0F);
        innerCycleRadius = DeviceUtils.getRealSize(mContext, 32.0F);
        ...
        outMostCircleRadius = DeviceUtils.getRealSize(mContext, 37.0F);
        outBlackCircleRadiusInc = DeviceUtils.getRealSize(mContext, 7.0F);
        innerCircleRadiusWhenRecord = DeviceUtils.getRealSize(mContext, 35.0F);
