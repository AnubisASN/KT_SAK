...
import color_picker.builder.ColorPickerClickListener
import color_picker.builder.ColorPickerDialogBuilder
...
class ColorPickerPreference : Preference {
    ...
    protected var wheelType: eColorPickerView.WHEEL_TYPE? = null
    ...
    private fun initWith(context: Context, attrs: AttributeSet) {
        ...
        try {
            ...
            wheelType =  when (typedArray.getInt(R.styleable.ColorPickerPreference_wheelType, 0)) {
                0 -> eColorPickerView.WHEEL_TYPE.FLOWER
                1 -> eColorPickerView.WHEEL_TYPE.CIRCLE
                else -> eColorPickerView.WHEEL_TYPE.FLOWER
            }
        ...
        widgetLayoutResource = R.layout.view_color_widget
    }
