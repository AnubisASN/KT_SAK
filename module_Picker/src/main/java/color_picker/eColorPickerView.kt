...
import color_picker.builder.ColorWheelRendererBuilder
...
class eColorPickerView : View {
    ...
    fun setLightnessSlider(lightnessSlider: eLightnessSlider?) {
    ...
    fun setAlphaSlider(alphaSlider: eAlphaSlider?) {
