...
public class eArcFace0 extends Activity implements ViewTreeObserver.OnGlobalLayoutListener{
    public static final String APP_ID = "5Q5zxyFtDAa8fRG6je1YVY7jKv5Gsq7tNEfdYQWaZQG8";
    public static final String SDK_KEY = "5BQBRJ2PnWWKAS7629dwdeTtp91p6jDJmDc153xUK5sK";
    ...
    public void activeEngine(final View view) {
        ...
        Observable.create(new ObservableOnSubscribe<Integer>() {
            ...
            public void subscribe(ObservableEmitter<Integer> emitter) throws Exception {
                ...
                int activeCode = faceEngine.active(eArcFace0.this, APP_ID, SDK_KEY);
