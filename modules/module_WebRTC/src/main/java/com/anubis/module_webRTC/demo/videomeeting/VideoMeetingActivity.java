...
public class VideoMeetingActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.anubis.module_webRTC.R.layout.activity_video_meeting);
        ...
        findViewById(com.anubis.module_webRTC.R.id.push_rtmp).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(rtmpPushing){
                    stopPushRtmp();
        ...
        findViewById(com.anubis.module_webRTC.R.id.mic_btn).setSelected(true);
        findViewById(com.anubis.module_webRTC.R.id.camera_btn).setSelected(true);
        findViewById(com.anubis.module_webRTC.R.id.camera_btn).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(findViewById(com.anubis.module_webRTC.R.id.camera_btn).isSelected()){
                    findViewById(com.anubis.module_webRTC.R.id.camera_btn).setSelected(false);
        ...
        findViewById(com.anubis.module_webRTC.R.id.mic_btn).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(findViewById(com.anubis.module_webRTC.R.id.mic_btn).isSelected()){
                    findViewById(com.anubis.module_webRTC.R.id.mic_btn).setSelected(false);
    ...
    private void showAddDialog(){
        final Dialog dialog = new Dialog(this, com.anubis.module_webRTC.R.style.dialog_popup);
        dialog.setContentView(com.anubis.module_webRTC.R.layout.dialog_input_rtmp_url);
        ((EditText)dialog.findViewById(com.anubis.module_webRTC.R.id.rtmpurl)).setText("rtmp://");
        ((EditText)dialog.findViewById(com.anubis.module_webRTC.R.id.rtmpurl)).setText("rtmp://14.23.79.210:1935/live/demo.1573715762042");
        Window win = dialog.getWindow();
        win.setLayout(WindowManager.LayoutParams.MATCH_PARENT, WindowManager.LayoutParams.WRAP_CONTENT);
        win.setGravity(Gravity.CENTER);
        dialog.setCanceledOnTouchOutside(true);
        dialog.findViewById(com.anubis.module_webRTC.R.id.yes_btn).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
