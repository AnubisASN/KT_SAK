...
Java_com_anubis_module_1detection_face_1mnn_FaceSDKNative_FaceDetectionModelInit(JNIEnv *env, jobject instance,
...
Java_com_anubis_module_1detection_face_1mnn_FaceSDKNative_FaceDetect(JNIEnv *env, jobject instance, jbyteArray imageDate_,
...
JNIEXPORT jboolean JNICALL
Java_com_anubis_module_1detection_face_1mnn_FaceSDKNative_FaceDetectionModelUnInit(JNIEnv *env, jobject instance) {
