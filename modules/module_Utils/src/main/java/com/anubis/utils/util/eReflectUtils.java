 ...
 * </pre>
 */
public final class eReflectUtils {

    private final Class<?> type;

    private final Object object;

    private eReflectUtils(final Class<?> type) {
        this(type, type);
    }

    private eReflectUtils(final Class<?> type, Object object) {
        this.type = type;
        this.object = object;
    }
     ...
     * @return the single {@link eReflectUtils} instance
     * @throws ReflectException if reflect unsuccessfully
     */
    public static eReflectUtils reflect(final String className)
     ...
     * @throws ReflectException if reflect unsuccessfully
     */
    public static eReflectUtils reflect(final String className, final ClassLoader classLoader)
            throws ReflectException {
     ...
     * @throws ReflectException if reflect unsuccessfully
     */
    public static eReflectUtils reflect(final Class<?> clazz)
            throws ReflectException {
        return new eReflectUtils(clazz);
    }
     ...
     * @throws ReflectException if reflect unsuccessfully
     */
    public static eReflectUtils reflect(final Object object)
            throws ReflectException {
        return new eReflectUtils(object == null ? Object.class : object.getClass(), object);
    }
     ...
     * @return the single {@link eReflectUtils} instance
     */
    public eReflectUtils newInstance() {
     ...
     * @return the single {@link eReflectUtils} instance
     */
    public eReflectUtils newInstance(Object... args) {
    ...
    private eReflectUtils newInstance(final Constructor<?> constructor, final Object... args) {
        try {
            return new eReflectUtils(
     ...
     * @return the single {@link eReflectUtils} instance
     */
    public eReflectUtils field(final String name) {
        try {
            Field field = getField(name);
            return new eReflectUtils(field.getType(), field.get(object));
     ...
     * @return the single {@link eReflectUtils} instance
     */
    public eReflectUtils field(String name, Object value) {
        try {
            Field field = getField(name);
    ...
    private Object unwrap(Object object) {
        if (object instanceof eReflectUtils) {
            return ((eReflectUtils) object).get();
        }
        return object;
    }
     ...
     * @throws ReflectException if reflect unsuccessfully
     */
    public eReflectUtils method(final String name) throws ReflectException {
     ...
     * @throws ReflectException if reflect unsuccessfully
     */
    public eReflectUtils method(final String name, final Object... args) throws ReflectException {
        Class<?>[] types = getArgsType(args);
        try {
    ...
    private eReflectUtils method(final Method method, final Object obj, final Object... args) {
        try {
            accessible(method);
    ...
    public boolean equals(Object obj) {
        return obj instanceof eReflectUtils && object.equals(((eReflectUtils) obj).get());
    }
