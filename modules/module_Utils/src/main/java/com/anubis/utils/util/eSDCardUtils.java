 ...
 * </pre>
 */
public final class eSDCardUtils {

    private eSDCardUtils() {
    ...
    public static List<String> getSDCardPaths(final boolean removable) {
        ...
        StorageManager sm =
                (StorageManager) eUtils.getApp().getSystemService(Context.STORAGE_SERVICE);
        try {
    ...
    public static List<String> getSDCardPaths() {
        StorageManager storageManager = (StorageManager) eUtils.getApp()
