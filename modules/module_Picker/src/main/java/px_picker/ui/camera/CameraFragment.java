...
import px_picker.ui.BaseFragment;
import px_picker.ui.camera.config.model.Camera;
import px_picker.ui.camera.config.model.Flash;
import px_picker.ui.camera.config.model.MediaAction;
import px_picker.ui.camera.config.model.Record;
import px_picker.ui.camera.config.CameraConfig;
import px_picker.ui.camera.config.CameraConfigProvider;
import px_picker.ui.camera.config.CameraConfigProviderImpl;
import px_picker.ui.camera.config.PictureQualityOption;
import px_picker.ui.camera.config.VideoQualityOption;
import px_picker.ui.camera.lifecycle.CameraLifecycle;
import px_picker.ui.camera.lifecycle.impl.Camera1Lifecycle;
import px_picker.ui.camera.lifecycle.impl.Camera2Lifecycle;
import px_picker.ui.camera.lifecycle.listener.CameraView;
import px_picker.ui.camera.listener.CameraControlListener;
import px_picker.ui.camera.listener.CameraStateListener;
import px_picker.ui.camera.listener.CameraVideoRecordTextListener;
import px_picker.ui.camera.listener.ICameraFragment;
import px_picker.ui.camera.listener.OnCameraResultListener;
import px_picker.ui.camera.util.CameraUtils;
import px_picker.ui.camera.util.Size;
import px_picker.ui.camera.util.DeviceUtils;
import px_picker.ui.camera.util.timer.CountdownTask;
import px_picker.ui.camera.util.timer.TimerTask;
import px_picker.ui.camera.util.timer.TimerTaskBase;
import px_picker.ui.camera.widget.AutoFitFrameLayout;
...
public class CameraFragment<CameraId> extends BaseFragment implements ICameraFragment {
    ...
    private androidx.appcompat.app.AlertDialog mSettingsDialog;
    private CameraLifecycle mCameraLifecycle;

    private CameraConfig mCameraConfig;
    @CameraConfig.MediaQuality
    private int mNewQuality ;
