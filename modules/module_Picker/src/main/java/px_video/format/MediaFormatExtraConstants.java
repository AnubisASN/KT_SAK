...
public class MediaFormatExtraConstants {
    ...
    public static final String MIMETYPE_VIDEO_AVC = "px_video/avc";
    public static final String MIMETYPE_VIDEO_H263 = "px_video/3gpp";
    public static final String MIMETYPE_VIDEO_VP8 = "px_video/x-vnd.on2.vp8";
