...
public class ScannerView extends RelativeLayout {
    ...
    public void initCamera(CameraSelector type) {
        ...
        cameraProviderFuture.addListener(() -> {
            ...
            try {
                ...
                // 绑定 UseCase 到相机
                camera = cameraProvider.bindToLifecycle((LifecycleOwner) getContext(),type, preview, imageAnalyzer);
    ...
    public void setScannerOptions(ScannerOptions scannerOptions, CameraSelector type) {
