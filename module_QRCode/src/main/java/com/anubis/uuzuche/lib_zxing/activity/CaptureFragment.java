...
import com.anubis.uuzuche.lib_zxing.decoding.CaptureActivityHandler;
import com.anubis.uuzuche.lib_zxing.decoding.InactivityTimer;
import com.anubis.uuzuche.lib_zxing.view.ViewfinderView;
...
public class CaptureFragment extends Fragment implements SurfaceHolder.Callback {
    ...
    private eQRCodeScan.AnalyzeCallback analyzeCallback;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = null;
        if (bundle != null) {
            int layoutId = bundle.getInt(eCodeUtils.LAYOUT_ID);
            if (layoutId != -1) {
    ...
    public eQRCodeScan.AnalyzeCallback getAnalyzeCallback() {
        return analyzeCallback;
    }

    public void setAnalyzeCallback(eQRCodeScan.AnalyzeCallback analyzeCallback, int cameraId) {
