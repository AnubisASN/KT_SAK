...
import com.anubis.module_tensorflow.detection.customview.OverlayView.DrawCallback
...
class DetectorActivity : CameraActivity(), OnImageAvailableListener {
    ...
    public override fun onPreviewSizeChosen(size: Size, rotation: Int) {
        val textSizePx = TypedValue.applyDimension(
                TypedValue.COMPLEX_UNIT_DIP, TEXT_SIZE_DIP, this@DetectorActivity.resources.displayMetrics)
