 ...
 * </pre>
 */
public final class eKeyboardUtils {
    ...
    public static void showSoftInput(final View view) {
        InputMethodManager imm =
                (InputMethodManager) eUtils.getApp().getSystemService(Context.INPUT_METHOD_SERVICE);
        view.setFocusable(true);
        view.setFocusableInTouchMode(true);
        view.requestFocus();
    ...
    private static int getDecorViewInvisibleHeight(final Activity activity) {
        ...
        Log.d("eKeyboardUtils", "getDecorViewInvisibleHeight: "
    ...
    private static int getContentViewInvisibleHeight(final Activity activity) {
        ...
        Log.d("eKeyboardUtils", "getContentViewInvisibleHeight: "
    ...
    public static void clickBlankArea2HideSoftInput() {
        Log.i("eKeyboardUtils", "Please refer to the following code.");
        /*
        @Override
