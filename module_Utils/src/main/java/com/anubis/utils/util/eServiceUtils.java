 ...
 * </pre>
 */
public final class eServiceUtils {

    private eServiceUtils() {
    ...
    public static void startService(final Class<?> cls) {
        Intent intent = new Intent(eUtils.getApp(), cls);
        eUtils.getApp().startService(intent);
    }
    ...
    public static boolean stopService(final Class<?> cls) {
        Intent intent = new Intent(eUtils.getApp(), cls);
        return eUtils.getApp().stopService(intent);
    }
    ...
    public static void bindService(final Class<?> cls,
                                   ...
                                   final int flags) {
        Intent intent = new Intent(eUtils.getApp(), cls);
        eUtils.getApp().bindService(intent, conn, flags);
    }
    ...
    public static void unbindService(final ServiceConnection conn) {
        eUtils.getApp().unbindService(conn);
    }
