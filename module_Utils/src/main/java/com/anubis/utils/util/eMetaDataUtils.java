 ...
 * </pre>
 */
public final class eMetaDataUtils {

    private eMetaDataUtils() {
    ...
    public static String getMetaDataInApp(@NonNull final String key) {
        ...
        String packageName = eUtils.getApp().getPackageName();
        try {
    ...
    public static String getMetaDataInActivity(@NonNull final Class<? extends AppCompatActivity> clz,
        ...
        String value = "";
        PackageManager pm = eUtils.getApp().getPackageManager();
        ComponentName componentName = new ComponentName(eUtils.getApp(), clz);
        try {
