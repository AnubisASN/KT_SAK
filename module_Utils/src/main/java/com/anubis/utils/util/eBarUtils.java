...
public final class eBarUtils {
    ...
    public static int getActionBarHeight() {
        ...
        if (eUtils.getApp().getTheme().resolveAttribute(android.R.attr.actionBarSize, tv, true)) {
            return TypedValue.complexToDimensionPixelSize(
                    tv.data, eUtils.getApp().getResources().getDisplayMetrics()
            );
        }
        return 0;
    }
    ...
    private static void invokePanels(final String methodName) {
        try {
            ...
            Object service = eUtils.getApp().getSystemService("statusbar");
    ...
    public static boolean isSupportNavBar() {
        ...
        boolean menu = ViewConfiguration.get(eUtils.getApp()).hasPermanentMenuKey();
