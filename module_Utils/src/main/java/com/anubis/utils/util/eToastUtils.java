...
public final class eToastUtils {
    ...
    private static void show(@StringRes final int resId, final int duration) {
        show(eUtils.getApp().getResources().getText(resId).toString(), duration);
    }

    private static void show(@StringRes final int resId, final int duration, final Object... args) {
        show(String.format(eUtils.getApp().getResources().getString(resId), args), duration);
    }
    ...
    private static void show(final CharSequence text, final int duration) {
        HANDLER.post(new Runnable() {
            ...
            public void run() {
                cancel();
                if (eUtils.isAdaptScreen()) {
                    eUtils.cancelAdaptScreen();
                    sToast = ToastFactory.makeToast(eUtils.getApp(), text, duration);
    ...
    private static void show(final View view, final int duration) {
        HANDLER.post(new Runnable() {
            ...
            public void run() {
                cancel();
                sToast = ToastFactory.newToast(eUtils.getApp());
                sToast.setView(view);
    ...
    private static View getView(@LayoutRes final int layoutId) {
        LayoutInflater inflate =
                (LayoutInflater) eUtils.getApp().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
    ...
    static class ToastFactory {
        ...
        static IToast makeToast(Context context, CharSequence text, int duration) {
            ...
            Log.e("eToastUtils", "Toast is GG. In fact, next step is useless.");
            return new SystemToast(makeNormalToast(context, text, duration));
        }
    ...
    static class ToastWithoutNotification implements IToast {
        ...
        public void show() {
            ...
            mParams.packageName = eUtils.getApp().getPackageName();
