 ...
 * </pre>
 */
public final class eFlashlightUtils {

    private static final String TAG = "eFlashlightUtils";

    private Camera mCamera;

    private eFlashlightUtils() {
    }

    /**
     * Return the single {@link eFlashlightUtils} instance.
     *
     * @return the single {@link eFlashlightUtils} instance
     */
    public static eFlashlightUtils getInstance() {
    ...
    private static final class LazyHolder {
        private static final eFlashlightUtils INSTANCE = new eFlashlightUtils();
    }
}
