 ...
 * </pre>
 */
public final class eScreenUtils {

    private eScreenUtils() {
    ...
    public static int getScreenWidth() {
        WindowManager wm = (WindowManager) eUtils.getApp().getSystemService(Context.WINDOW_SERVICE);
    ...
    public static boolean isLandscape() {
        return eUtils.getApp().getResources().getConfiguration().orientation
    ...
    public static boolean isScreenLock() {
        KeyguardManager km =
                (KeyguardManager) eUtils.getApp().getSystemService(Context.KEYGUARD_SERVICE);
        //noinspection ConstantConditions
    ...
    public static boolean isTablet() {
        return (eUtils.getApp().getResources().getConfiguration().screenLayout
    ...
    private static void adaptScreen(final Activity activity,
        ...
        eUtils.ADAPT_SCREEN_ARGS.sizeInPx = sizeInPx;
        eUtils.ADAPT_SCREEN_ARGS.isVerticalSlide = isVerticalSlide;
    }
