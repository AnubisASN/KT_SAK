 ...
 * </pre>
 */
public final class eCrashUtils {
    ...
    static {
        try {
            PackageInfo pi = eUtils.getApp()
                    .getPackageManager()
                    .getPackageInfo(eUtils.getApp().getPackageName(), 0);
            if (pi != null) {
        ...
        UNCAUGHT_EXCEPTION_HANDLER = new UncaughtExceptionHandler() {
            ...
            public void uncaughtException(final Thread t, final Throwable e) {
                ...
                if (createOrExistsFile(fullPath)) {
                    ...
                    Log.e("eCrashUtils", "create " + fullPath + " failed!");
                }
    ...
    public static void init(final String crashDirPath, final OnCrashListener onCrashListener) {
        ...
        if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())
                && eUtils.getApp().getExternalCacheDir() != null)
            defaultDir = eUtils.getApp().getExternalCacheDir() + FILE_SEP + "crash" + FILE_SEP;
        else {
            defaultDir = eUtils.getApp().getCacheDir() + FILE_SEP + "crash" + FILE_SEP;
        }
    ...
    private static void input2File(final String input, final String filePath) {
        ...
        Log.e("eCrashUtils", "write crash info to " + filePath + " failed!");
    }
