...
public class ePathUtils {
    ...
    public static String getInternalAppDataPath() {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.N) {
            return eUtils.getApp().getApplicationInfo().dataDir;
        }
        return eUtils.getApp().getDataDir().getAbsolutePath();
    }
    ...
    public static String getInternalAppCodeCacheDir() {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.LOLLIPOP) {
            return eUtils.getApp().getApplicationInfo().dataDir + "/code_cache";
        }
        return eUtils.getApp().getCodeCacheDir().getAbsolutePath();
    }
    ...
    public static String getInternalAppCachePath() {
        return eUtils.getApp().getCacheDir().getAbsolutePath();
    }
    ...
    public static String getInternalAppDbsPath() {
        return eUtils.getApp().getApplicationInfo().dataDir + "/databases";
    }
    ...
    public static String getInternalAppDbPath(String name) {
        return eUtils.getApp().getDatabasePath(name).getAbsolutePath();
    }
    ...
    public static String getInternalAppFilesPath() {
        return eUtils.getApp().getFilesDir().getAbsolutePath();
    }
    ...
    public static String getInternalAppSpPath() {
        return eUtils.getApp().getApplicationInfo().dataDir + "shared_prefs";
    }
    ...
    public static String getInternalAppNoBackupFilesPath() {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.LOLLIPOP) {
            return eUtils.getApp().getApplicationInfo().dataDir + "no_backup";
        }
        return eUtils.getApp().getNoBackupFilesDir().getAbsolutePath();
    }
    ...
    public static String getExternalAppDataPath() {
        ...
        return eUtils.getApp().getExternalCacheDir().getParentFile().getAbsolutePath();
    }
    ...
    public static String getExternalAppCachePath() {
        if (isExternalStorageDisable()) return "";
        //noinspection ConstantConditions
        return eUtils.getApp().getExternalCacheDir().getAbsolutePath();
    }
    ...
    public static String getExternalAppFilesPath() {
        if (isExternalStorageDisable()) return "";
        //noinspection ConstantConditions
        return eUtils.getApp().getExternalFilesDir(null).getAbsolutePath();
    }
    ...
    public static String getExternalAppMusicPath() {
        if (isExternalStorageDisable()) return "";
        //noinspection ConstantConditions
        return eUtils.getApp().getExternalFilesDir(Environment.DIRECTORY_MUSIC).getAbsolutePath();
    }
    ...
    public static String getExternalAppPodcastsPath() {
        if (isExternalStorageDisable()) return "";
        //noinspection ConstantConditions
        return eUtils.getApp().getExternalFilesDir(Environment.DIRECTORY_PODCASTS).getAbsolutePath();
    }
    ...
    public static String getExternalAppRingtonesPath() {
        if (isExternalStorageDisable()) return "";
        //noinspection ConstantConditions
        return eUtils.getApp().getExternalFilesDir(Environment.DIRECTORY_RINGTONES).getAbsolutePath();
    }
    ...
    public static String getExternalAppAlarmsPath() {
        if (isExternalStorageDisable()) return "";
        //noinspection ConstantConditions
        return eUtils.getApp().getExternalFilesDir(Environment.DIRECTORY_ALARMS).getAbsolutePath();
    }
    ...
    public static String getExternalAppNotificationsPath() {
        if (isExternalStorageDisable()) return "";
        //noinspection ConstantConditions
        return eUtils.getApp().getExternalFilesDir(Environment.DIRECTORY_NOTIFICATIONS).getAbsolutePath();
    }
    ...
    public static String getExternalAppPicturesPath() {
        if (isExternalStorageDisable()) return "";
        //noinspection ConstantConditions
        return eUtils.getApp().getExternalFilesDir(Environment.DIRECTORY_PICTURES).getAbsolutePath();
    }
    ...
    public static String getExternalAppMoviesPath() {
        if (isExternalStorageDisable()) return "";
        //noinspection ConstantConditions
        return eUtils.getApp().getExternalFilesDir(Environment.DIRECTORY_MOVIES).getAbsolutePath();
    }
    ...
    public static String getExternalAppDownloadPath() {
        if (isExternalStorageDisable()) return "";
        //noinspection ConstantConditions
        return eUtils.getApp().getExternalFilesDir(Environment.DIRECTORY_DOWNLOADS).getAbsolutePath();
    }
    ...
    public static String getExternalAppDcimPath() {
        if (isExternalStorageDisable()) return "";
        //noinspection ConstantConditions
        return eUtils.getApp().getExternalFilesDir(Environment.DIRECTORY_DCIM).getAbsolutePath();
    }
    ...
    public static String getExternalAppDocumentsPath() {
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.KITKAT) {
            //noinspection ConstantConditions
            return eUtils.getApp().getExternalFilesDir(null).getAbsolutePath() + "/Documents";
        }
        //noinspection ConstantConditions
        return eUtils.getApp().getExternalFilesDir(Environment.DIRECTORY_DOCUMENTS).getAbsolutePath();
    }
    ...
    public static String getExternalAppObbPath() {
        if (isExternalStorageDisable()) return "";
        return eUtils.getApp().getObbDir().getAbsolutePath();
    }
