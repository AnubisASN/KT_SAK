 ...
 * </pre>
 */
public final class eSnackbarUtils {
    ...
    private eSnackbarUtils(final View parent) {
        setDefault();
        this.view = parent;
    }
     ...
     * @return the single {@link eSnackbarUtils} instance
     */
    public static eSnackbarUtils with(@NonNull final View view) {
        return new eSnackbarUtils(view);
    }
     ...
     * @return the single {@link eSnackbarUtils} instance
     */
    public eSnackbarUtils setMessage(@NonNull final CharSequence msg) {
        this.message = msg;
        return this;
    }
     ...
     * @return the single {@link eSnackbarUtils} instance
     */
    public eSnackbarUtils setMessageColor(@ColorInt final int color) {
     ...
     * @return the single {@link eSnackbarUtils} instance
     */
    public eSnackbarUtils setBgColor(@ColorInt final int color) {
        this.bgColor = color;
        return this;
    }
     ...
     * @return the single {@link eSnackbarUtils} instance
     */
    public eSnackbarUtils setBgResource(@DrawableRes final int bgResource) {
     ...
     * @return the single {@link eSnackbarUtils} instance
     */
    public eSnackbarUtils setDuration(@Duration final int duration) {
     ...
     * @return the single {@link eSnackbarUtils} instance
     */
    public eSnackbarUtils setAction(@NonNull final CharSequence text,
     ...
     */
    public eSnackbarUtils setBottomMargin(@IntRange(from = 1) final int bottomMargin) {
