 ...
 * </pre>
 */
public final class eBrightnessUtils {

    private eBrightnessUtils() {
    ...
    public static boolean setAutoBrightnessEnabled(final boolean enabled) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M
                && !Settings.System.canWrite(eUtils.getApp())) {
    ...
    public static boolean setBrightness(@IntRange(from = 0, to = 255) final int brightness) {
        ...
        ContentResolver resolver = eUtils.getApp().getContentResolver();
