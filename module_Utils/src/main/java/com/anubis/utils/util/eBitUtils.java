...
public final class eBitUtils {
    ...
    public static void main(String[] args) {
        ...
        for (byte i = 7; i >= 0; i--) {
            Log.d("eBitUtils", getBitValue(source, i) + "");

        }
        // 将第6位置为1并输出 , 结果为 75 (0100 1011)
        Log.d("eBitUtils", setBitValue(source, 6, (byte) 1) + "");

        // 将第6位取反并输出, 结果应为75(0100 1011)
        Log.d("eBitUtils", reverseBitValue(source, 6) + "");

        // 检查第6位是否为1，结果应为false
        Log.d("eBitUtils", checkBitValue(source, 6) + "");
