...
public final class eAppUtils {
    ...
    public static void registerAppStatusChangedListener(@NonNull final Object obj,
                                                        @NonNull final eUtils.OnAppStatusChangedListener listener) {
        eUtils.getActivityLifecycle().addListener(obj, listener);
    }
    ...
    public static void unregisterAppStatusChangedListener(@NonNull final Object obj) {
        eUtils.getActivityLifecycle().removeListener(obj);
    }
    ...
    public static void installApp(final File file) {
        ...
        eUtils.getApp().startActivity(getInstallAppIntent(file, true));
    }
    ...
    public static boolean installAppSilent(final File file,
        ...
        String command = "LD_LIBRARY_PATH=/vendor/lib*:/system/lib* pm install " +
                (params == null ? "" : params + " ")
                + filePath;
        eShellUtils.CommandResult commandResult = eShellUtils.execCmd(command, isRooted);
        if (commandResult.successMsg != null
                && commandResult.successMsg.toLowerCase().contains("success")) {
            return true;
        } else {
            Log.e("eAppUtils", "installAppSilent successMsg: " + commandResult.successMsg +
    ...
    public static void uninstallApp(final String packageName) {
        ...
        eUtils.getApp().startActivity(getUninstallAppIntent(packageName, true));
    }
    ...
    public static boolean uninstallAppSilent(final String packageName,
        ...
        if (commandResult.successMsg != null
            ...
            Log.e("eAppUtils", "uninstallAppSilent successMsg: " + commandResult.successMsg +
                    ", errorMsg: " + commandResult.errorMsg);
            return false;
        }
    }
    ...
    public static boolean isAppInstalled(@NonNull final String packageName) {
        return !isSpace(packageName)
                && eUtils.getApp().getPackageManager().getLaunchIntentForPackage(packageName) != null;
    }
    ...
    public static boolean isAppRoot() {
        eShellUtils.CommandResult result = eShellUtils.execCmd("echo root", true);
        if (result.result == 0) return true;
        if (result.errorMsg != null) {
            Log.d("eAppUtils", "isAppRoot() called" + result.errorMsg);
        }
        return false;
    }
    ...
    public static boolean isAppDebug() {
        return isAppDebug(eUtils.getApp().getPackageName());
    }
    ...
    public static boolean isAppSystem() {
        return isAppSystem(eUtils.getApp().getPackageName());
    }
    ...
    public static void launchApp(final String packageName) {
        if (isSpace(packageName)) return;
        eUtils.getApp().startActivity(getLaunchAppIntent(packageName, true));
    }
    ...
    public static void relaunchApp() {
        PackageManager packageManager = eUtils.getApp().getPackageManager();
        Intent intent = packageManager.getLaunchIntentForPackage(eUtils.getApp().getPackageName());
        if (intent == null) return;
        ComponentName componentName = intent.getComponent();
        Intent mainIntent = Intent.makeRestartActivityTask(componentName);
        eUtils.getApp().startActivity(mainIntent);
        System.exit(0);
    }
    ...
    public static void launchAppDetailsSettings() {
        launchAppDetailsSettings(eUtils.getApp().getPackageName());
    }
    ...
    public static void launchAppDetailsSettings(final String packageName) {
        ...
        eUtils.getApp().startActivity(intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK));
    }
    ...
    public static Drawable getAppIcon() {
        return getAppIcon(eUtils.getApp().getPackageName());
    }
    ...
    public static String getAppPackageName() {
        return eUtils.getApp().getPackageName();
    }
    ...
    public static String getAppName() {
        return getAppName(eUtils.getApp().getPackageName());
    }
    ...
    public static String getAppPath() {
        return getAppPath(eUtils.getApp().getPackageName());
    }
    ...
    public static String getAppVersionName() {
        return getAppVersionName(eUtils.getApp().getPackageName());
    }
    ...
    public static int getAppVersionCode() {
        return getAppVersionCode(eUtils.getApp().getPackageName());
    }
    ...
    public static Signature[] getAppSignature() {
        return getAppSignature(eUtils.getApp().getPackageName());
    }
    ...
    public static String getAppSignatureSHA1() {
        return getAppSignatureSHA1(eUtils.getApp().getPackageName());
    }
    ...
    public static String getAppSignatureSHA256() {
        return getAppSignatureSHA256(eUtils.getApp().getPackageName());
    }
    ...
    public static String getAppSignatureMD5() {
        return getAppSignatureMD5(eUtils.getApp().getPackageName());
    }
    ...
    public static AppInfo getAppInfo() {
        return getAppInfo(eUtils.getApp().getPackageName());
    }
    ...
    private static Intent getInstallAppIntent(final File file, final boolean isNewTask) {
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.N) {
            ...
            data = FileProvider.getUriForFile(eUtils.getApp(), authority, file);
        }
    ...
    private static Intent getLaunchAppIntent(final String packageName, final boolean isNewTask) {
        Intent intent = eUtils.getApp().getPackageManager().getLaunchIntentForPackage(packageName);
    ...
    private static String getForegroundProcessName() {
        ActivityManager am =
                (ActivityManager) eUtils.getApp().getSystemService(Context.ACTIVITY_SERVICE);
        ...
        if (Build.VERSION.SDK_INT > Build.VERSION_CODES.LOLLIPOP) {
            ...
            Log.i("eProcessUtils", list.toString());
            if (list.size() <= 0) {
                Log.i("eProcessUtils",
            ...
            try {// Access to usage information.
                ApplicationInfo info =
                        pm.getApplicationInfo(eUtils.getApp().getPackageName(), 0);
                AppOpsManager aom =
                        (AppOpsManager) eUtils.getApp().getSystemService(Context.APP_OPS_SERVICE);
                //noinspection ConstantConditions
                if (aom.checkOpNoThrow(AppOpsManager.OPSTR_GET_USAGE_STATS,
                        info.uid,
                        info.packageName) != AppOpsManager.MODE_ALLOWED) {
                    intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                    eUtils.getApp().startActivity(intent);
                }
                if (aom.checkOpNoThrow(AppOpsManager.OPSTR_GET_USAGE_STATS,
                        info.uid,
                        info.packageName) != AppOpsManager.MODE_ALLOWED) {
                ...
                UsageStatsManager usageStatsManager = (UsageStatsManager) eUtils.getApp()
