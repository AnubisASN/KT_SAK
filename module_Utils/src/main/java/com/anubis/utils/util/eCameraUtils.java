 ...
 * </pre>
 */
public final class eCameraUtils {

//    private eCameraUtils() {
...
//            }
//        }
//        return eStringUtils.isEmpty(path) ? originalUri.getPath() : null;
//    }
//
//    /**
//     * 获取拍照之后的照片文件（JPG格式）
...
//        if (eImageUtils.save(photo, file, Bitmap.CompressFormat.JPEG)) return file;
//        return null;
//    }
}
