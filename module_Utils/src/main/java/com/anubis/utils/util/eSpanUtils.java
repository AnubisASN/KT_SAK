...
public final class eSpanUtils {
     ...
     *             </ul>
     * @return the single {@link eSpanUtils} instance
     */
    public eSpanUtils setFlag(final int flag) {
        this.flag = flag;
        return this;
    }
     ...
     * @return the single {@link eSpanUtils} instance
     */
    public eSpanUtils setForegroundColor(@ColorInt final int color) {
     ...
     * @return the single {@link eSpanUtils} instance
     */
    public eSpanUtils setBackgroundColor(@ColorInt final int color) {
     ...
     * @return the single {@link eSpanUtils} instance
     */
    public eSpanUtils setLineHeight(@IntRange(from = 0) final int lineHeight) {
     ...
     * @return the single {@link eSpanUtils} instance
     */
    public eSpanUtils setQuoteColor(@ColorInt final int color) {
     ...
     * @return the single {@link eSpanUtils} instance
     */
    public eSpanUtils setLeadingMargin(@IntRange(from = 0) final int first,
     ...
     * @return the single {@link eSpanUtils} instance
     */
    public eSpanUtils setBullet(@IntRange(from = 0) final int gapWidth) {
     ...
     * @return the single {@link eSpanUtils} instance
     */
    public eSpanUtils setBullet(@ColorInt final int color,
     ...
     * @return the single {@link eSpanUtils} instance
     */
    public eSpanUtils setFontSize(@IntRange(from = 0) final int size) {
     ...
     * @return the single {@link eSpanUtils} instance
     */
    public eSpanUtils setFontSize(@IntRange(from = 0) final int size, final boolean isSp) {
        this.fontSize = size;
     ...
     * @return the single {@link eSpanUtils} instance
     */
    public eSpanUtils setFontProportion(final float proportion) {
     ...
     * @return the single {@link eSpanUtils} instance
     */
    public eSpanUtils setFontXProportion(final float proportion) {
     ...
     * @return the single {@link eSpanUtils} instance
     */
    public eSpanUtils setStrikethrough() {
     ...
     * @return the single {@link eSpanUtils} instance
     */
    public eSpanUtils setUnderline() {
     ...
     * @return the single {@link eSpanUtils} instance
     */
    public eSpanUtils setSuperscript() {
     ...
     * @return the single {@link eSpanUtils} instance
     */
    public eSpanUtils setSubscript() {
     ...
     * @return the single {@link eSpanUtils} instance
     */
    public eSpanUtils setBoldItalic() {
        isBoldItalic = true;
        return this;
    }
     ...
     * @return the single {@link eSpanUtils} instance
     */
    public eSpanUtils setFontFamily(@NonNull final String fontFamily) {
     ...
     * @return the single {@link eSpanUtils} instance
     */
    public eSpanUtils setTypeface(@NonNull final Typeface typeface) {
     ...
     * @return the single {@link eSpanUtils} instance
     */
    public eSpanUtils setAlign(@NonNull final Alignment alignment) {
     ...
     * @return the single {@link eSpanUtils} instance
     */
    public eSpanUtils setClickSpan(@NonNull final ClickableSpan clickSpan) {
     ...
     * @return the single {@link eSpanUtils} instance
     */
    public eSpanUtils setUrl(@NonNull final String url) {
        this.url = url;
        return this;
    }
     ...
     * @return the single {@link eSpanUtils} instance
     */
    public eSpanUtils setBlur(@FloatRange(from = 0, fromInclusive = false) final float radius,
                              final Blur style) {
     ...
     * @return the single {@link eSpanUtils} instance
     */
    public eSpanUtils setShader(@NonNull final Shader shader) {
        this.shader = shader;
        return this;
    }
     ...
     * @return the single {@link eSpanUtils} instance
     */
    public eSpanUtils setShadow(@FloatRange(from = 0, fromInclusive = false) final float radius,
                                final float dx,
                                final float dy,
     ...
     * @return the single {@link eSpanUtils} instance
     */
    public eSpanUtils setSpans(@NonNull final Object... spans) {
        if (spans.length > 0) {
            this.spans = spans;
        }
        return this;
     ...
     * @return the single {@link eSpanUtils} instance
     */
    public eSpanUtils append(@NonNull final CharSequence text) {
     ...
     * @return the single {@link eSpanUtils} instance
     */
    public eSpanUtils appendLine(@NonNull final CharSequence text) {
        apply(mTypeCharSequence);
     ...
     * @return the single {@link eSpanUtils} instance
     */
    public eSpanUtils appendImage(@NonNull final Bitmap bitmap) {
     ...
     * @return the single {@link eSpanUtils} instance
     */
    public eSpanUtils appendImage(@NonNull final Bitmap bitmap, @Align final int align) {
        apply(mTypeImage);
     ...
     * @return the single {@link eSpanUtils} instance
     */
    public eSpanUtils appendImage(@NonNull final Drawable drawable) {
     ...
     * @return the single {@link eSpanUtils} instance
     */
    public eSpanUtils appendImage(@NonNull final Drawable drawable, @Align final int align) {
        apply(mTypeImage);
     ...
     * @return the single {@link eSpanUtils} instance
     */
    public eSpanUtils appendImage(@NonNull final Uri uri) {
     ...
     * @return the single {@link eSpanUtils} instance
     */
    public eSpanUtils appendImage(@NonNull final Uri uri, @Align final int align) {
        apply(mTypeImage);
        this.imageUri = uri;
        this.alignImage = align;
        return this;
     ...
     * @return the single {@link eSpanUtils} instance
     */
    public eSpanUtils appendImage(@DrawableRes final int resourceId) {
     ...
     * @return the single {@link eSpanUtils} instance
     */
    public eSpanUtils appendImage(@DrawableRes final int resourceId, @Align final int align) {
     ...
     * @return the single {@link eSpanUtils} instance
     */
    public eSpanUtils appendSpace(@IntRange(from = 0) final int size) {
     ...
     * @return the single {@link eSpanUtils} instance
     */
    public eSpanUtils appendSpace(@IntRange(from = 0) final int size, @ColorInt final int color) {
        apply(mTypeSpace);
        spaceSize = size;
        spaceColor = color;
        return this;
...
//            }
    ...
    class CustomImageSpan extends CustomDynamicDrawableSpan {
        ...
        private CustomImageSpan(final Bitmap b, final int verticalAlignment) {
            ...
            mDrawable = new BitmapDrawable(eUtils.getApp().getResources(), b);
            mDrawable.setBounds(
        ...
        public Drawable getDrawable() {
            ...
            if (mDrawable != null) {
                ...
                try {
                    InputStream is =
                            eUtils.getApp().getContentResolver().openInputStream(mContentUri);
                    bitmap = BitmapFactory.decodeStream(is);
                    drawable = new BitmapDrawable(eUtils.getApp().getResources(), bitmap);
                    drawable.setBounds(
                ...
                try {
                    drawable = ContextCompat.getDrawable(eUtils.getApp(), mResourceId);
                    drawable.setBounds(
                            0, 0, drawable.getIntrinsicWidth(), drawable.getIntrinsicHeight()
                    );
                } catch (Exception e) {
...
//            eLogUtils.d("rectHeight: " + rect.height(),
