...
public final class eUtils {
    ...
    public static void init(final Application app) {
        if (sApplication == null) {
            if (app == null) {
                eUtils.sApplication = getApplicationByReflect();
            } else {
                eUtils.sApplication = app;
            }
            eUtils.sApplication.registerActivityLifecycleCallbacks(ACTIVITY_LIFECYCLE);
        }
    }
    ...
    static boolean isAppForeground() {
        ...
        for (ActivityManager.RunningAppProcessInfo aInfo : info) {
            if (aInfo.importance == ActivityManager.RunningAppProcessInfo.IMPORTANCE_FOREGROUND) {
                return aInfo.processName.equals(eUtils.getApp().getPackageName());
            }
        }
        return false;
    }
