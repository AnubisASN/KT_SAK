 ...
 * </pre>
 */
public final class eProcessUtils {

    private eProcessUtils() {
    ...
    public static boolean isMainProcess() {
        return eUtils.getApp().getPackageName().equals(getCurrentProcessName());
    }
    ...
    public static String getCurrentProcessName() {
        ActivityManager am = (ActivityManager) eUtils.getApp().getSystemService(Context.ACTIVITY_SERVICE);
        //noinspection ConstantConditions
        List<ActivityManager.RunningAppProcessInfo> info = am.getRunningAppProcesses();
