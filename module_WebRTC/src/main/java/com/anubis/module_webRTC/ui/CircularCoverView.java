package com.anubis.module_webRTC.ui;
...
public class CircularCoverView extends View {
    ...
    public CircularCoverView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray typedArray = context.obtainStyledAttributes(attrs, com.anubis.module_webRTC.R.styleable.CircularCoverView);
        leftTopRadians = typedArray.getDimensionPixelSize(com.anubis.module_webRTC.R.styleable.CircularCoverView_left_top_radius, leftTopRadians);
        leftBottomRadians = typedArray.getDimensionPixelSize(com.anubis.module_webRTC.R.styleable.CircularCoverView_left_bottom_radius, leftBottomRadians);
        rightTopRadians = typedArray.getDimensionPixelSize(com.anubis.module_webRTC.R.styleable.CircularCoverView_right_top_radius, rightTopRadians);
        rightBottomRadians = typedArray.getDimensionPixelSize(com.anubis.module_webRTC.R.styleable.CircularCoverView_right_bottom_radius, rightBottomRadians);
        coverColor = typedArray.getColor(com.anubis.module_webRTC.R.styleable.CircularCoverView_cover_color, coverColor);
    }
