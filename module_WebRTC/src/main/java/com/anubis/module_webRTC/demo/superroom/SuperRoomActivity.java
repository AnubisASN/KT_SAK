...
public class SuperRoomActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.anubis.module_webRTC.R.layout.activity_super_room);
        ...
        vNameArray.add((TextView) findViewById(com.anubis.module_webRTC.R.id.mc_id));
        ...
        vHeadArray.add((ImageView) findViewById(com.anubis.module_webRTC.R.id.mic_head));
        ...
        vOnlineNum = findViewById(com.anubis.module_webRTC.R.id.online_text);
