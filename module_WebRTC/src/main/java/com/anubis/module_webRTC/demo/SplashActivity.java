...
public class SplashActivity extends Activity {
    ...
    private void startAnimation(){
        isLogin = true;
        final View eye = findViewById(com.anubis.module_webRTC.R.id.eye);
        eye.setAlpha(0.2f);
        final View black = findViewById(com.anubis.module_webRTC.R.id.black_view);
        final View white = findViewById(com.anubis.module_webRTC.R.id.white_view);
