...
public class MiniClassActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(dm.heightPixels>dm.widthPixels){
            isPortrait = true;
            setContentView(com.anubis.module_webRTC.R.layout.activity_mini_class);
        }else{
            isPortrait = false;
            setContentView(com.anubis.module_webRTC.R.layout.activity_mini_class_landscape);
        }
        vPlayerView = (RelativeLayout) findViewById(com.anubis.module_webRTC.R.id.view1);
        ...
        vMeetingName = (TextView) findViewById(com.anubis.module_webRTC.R.id.live_id_text);
        vMeetingName.setText("ID："+ className);
        vPaintPlayer = (StarWhitePanel2) findViewById(com.anubis.module_webRTC.R.id.painter_view);
        vPaintPlayer.setImageHost("api.starrtc.com");

        findViewById(com.anubis.module_webRTC.R.id.chat_btn).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                findViewById(com.anubis.module_webRTC.R.id.white_panel_view).setVisibility(View.INVISIBLE);
                findViewById(com.anubis.module_webRTC.R.id.chat_message_view).setVisibility(View.VISIBLE);
            }
        });
        findViewById(com.anubis.module_webRTC.R.id.panel_btn).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                findViewById(com.anubis.module_webRTC.R.id.white_panel_view).setVisibility(View.VISIBLE);
                findViewById(com.anubis.module_webRTC.R.id.chat_message_view).setVisibility(View.INVISIBLE);
            }
        });
        findViewById(com.anubis.module_webRTC.R.id.send_btn).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String txt = ((EditText)findViewById(com.anubis.module_webRTC.R.id.id_input)).getText().toString();
                if(!TextUtils.isEmpty(txt)){
                    sendChatMsg(txt);
                    ((EditText)findViewById(com.anubis.module_webRTC.R.id.id_input)).setText("");
                }
                InputMethodManager imm = (InputMethodManager) getSystemService(Context.INPUT_METHOD_SERVICE);
                imm.hideSoftInputFromWindow(((EditText)findViewById(com.anubis.module_webRTC.R.id.id_input)).getWindowToken(), 0);
            }
        });

        vCameraBtn = (ImageView) findViewById(com.anubis.module_webRTC.R.id.camera_btn);
        vMicBtn = (ImageView) findViewById(com.anubis.module_webRTC.R.id.mic_btn);
        vLinkBtn = (TextView) findViewById(com.anubis.module_webRTC.R.id.link_btn);
        vCleanBtn = (ImageView) findViewById(com.anubis.module_webRTC.R.id.clean_btn);
        ...
        vRevokeBtn = (ImageView) findViewById(com.anubis.module_webRTC.R.id.revoke_btn);
        ...
        vLaserPenBtn = (ImageView) findViewById(com.anubis.module_webRTC.R.id.laser_btn);
        ...
        vSelectColorView = findViewById(com.anubis.module_webRTC.R.id.select_color_view);
        vSelectColorBtn = (ImageView)findViewById(com.anubis.module_webRTC.R.id.select_color_btn);
        ...
        View.OnClickListener colorClickListener = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                switch (v.getId()){
                    case com.anubis.module_webRTC.R.id.select_color_black:
                        vPaintPlayer.setSelectColor(0x000000);
                        vSelectColorBtn.setBackgroundResource(com.anubis.module_webRTC.R.drawable.pen_color_bg_black);
                        break;
                    case com.anubis.module_webRTC.R.id.select_color_red:
                        vPaintPlayer.setSelectColor(0xcf0206);
                        vSelectColorBtn.setBackgroundResource(com.anubis.module_webRTC.R.drawable.pen_color_bg_red);
                        break;
                    case com.anubis.module_webRTC.R.id.select_color_yellow:
                        vPaintPlayer.setSelectColor(0xf59b00);
                        vSelectColorBtn.setBackgroundResource(com.anubis.module_webRTC.R.drawable.pen_color_bg_yellow);
                        break;
                    case com.anubis.module_webRTC.R.id.select_color_green:
                        vPaintPlayer.setSelectColor(0x3dc25a);
                        vSelectColorBtn.setBackgroundResource(com.anubis.module_webRTC.R.drawable.pen_color_bg_green);
                        break;
                    case com.anubis.module_webRTC.R.id.select_color_blue:
                        vPaintPlayer.setSelectColor(0x0029f7);
                        vSelectColorBtn.setBackgroundResource(com.anubis.module_webRTC.R.drawable.pen_color_bg_blue);
                        break;
                    case com.anubis.module_webRTC.R.id.select_color_purple:
                        vPaintPlayer.setSelectColor(0x8600a7);
                        vSelectColorBtn.setBackgroundResource(com.anubis.module_webRTC.R.drawable.pen_color_bg_purple);
                        break;
                }
                vSelectColorView.setVisibility(View.INVISIBLE);
            }
        };
        findViewById(com.anubis.module_webRTC.R.id.select_color_black).setOnClickListener(colorClickListener);
        findViewById(com.anubis.module_webRTC.R.id.select_color_red).setOnClickListener(colorClickListener);
        findViewById(com.anubis.module_webRTC.R.id.select_color_yellow).setOnClickListener(colorClickListener);
        findViewById(com.anubis.module_webRTC.R.id.select_color_green).setOnClickListener(colorClickListener);
        findViewById(com.anubis.module_webRTC.R.id.select_color_blue).setOnClickListener(colorClickListener);
        findViewById(com.anubis.module_webRTC.R.id.select_color_purple).setOnClickListener(colorClickListener);
        ...
        vMsgList = (ListView) findViewById(com.anubis.module_webRTC.R.id.msg_list);
        ...
        findViewById(com.anubis.module_webRTC.R.id.back_btn).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                onBackPressed();
            }
    ...
    public class MyChatroomListAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            if(convertView == null){
                ...
                convertView = mInflater.inflate(com.anubis.module_webRTC.R.layout.item_class_msg_list,null);
                holder.vUserId = (TextView) convertView.findViewById(com.anubis.module_webRTC.R.id.item_user_id);
                holder.vMsg = (TextView) convertView.findViewById(com.anubis.module_webRTC.R.id.item_msg);
