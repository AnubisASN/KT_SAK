...
public class AudioLiveActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.anubis.module_webRTC.R.layout.activity_audio_live);
        ...
        vCreatorName = (TextView) findViewById(com.anubis.module_webRTC.R.id.mc_id);
        vCreatorHead = (ImageView) findViewById(com.anubis.module_webRTC.R.id.mic_head);
        vNameArray = new ArrayList<>();
        vNameArray.add((TextView) findViewById(com.anubis.module_webRTC.R.id.mc_id_1));
        vNameArray.add((TextView) findViewById(com.anubis.module_webRTC.R.id.mc_id_2));
        vNameArray.add((TextView) findViewById(com.anubis.module_webRTC.R.id.mc_id_3));
        vNameArray.add((TextView) findViewById(com.anubis.module_webRTC.R.id.mc_id_4));
        vNameArray.add((TextView) findViewById(com.anubis.module_webRTC.R.id.mc_id_5));
        vNameArray.add((TextView) findViewById(com.anubis.module_webRTC.R.id.mc_id_6));
        vHeadArray = new ArrayList<>();
        vHeadArray.add((ImageView) findViewById(com.anubis.module_webRTC.R.id.mc_head_1));
        vHeadArray.add((ImageView) findViewById(com.anubis.module_webRTC.R.id.mc_head_2));
        vHeadArray.add((ImageView) findViewById(com.anubis.module_webRTC.R.id.mc_head_3));
        vHeadArray.add((ImageView) findViewById(com.anubis.module_webRTC.R.id.mc_head_4));
        vHeadArray.add((ImageView) findViewById(com.anubis.module_webRTC.R.id.mc_head_5));
        vHeadArray.add((ImageView) findViewById(com.anubis.module_webRTC.R.id.mc_head_6));
        ...
        addListener();
        vRoomId = (TextView) findViewById(com.anubis.module_webRTC.R.id.live_id_text);
        ...
        vEditText = (EditText) findViewById(com.anubis.module_webRTC.R.id.id_input);
        ...
        vSendBtn = findViewById(com.anubis.module_webRTC.R.id.send_btn);
        ...
        vPushBtn = findViewById(com.anubis.module_webRTC.R.id.push_btn);
    ...
    private void addPlayer(String addUserID){
        ...
        for(int i = 0;i<vNameArray.size();i++){
            ...
            if(mNameArray[i].isEmpty()){
                vHeadArray.get(i).setImageResource(com.anubis.module_webRTC.R.drawable.icon_add_more);
            }
        }
    }
    ...
    public class MyChatroomListAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            if(convertView == null){
                ...
                convertView = mInflater.inflate(com.anubis.module_webRTC.R.layout.item_live_msg_list,null);
