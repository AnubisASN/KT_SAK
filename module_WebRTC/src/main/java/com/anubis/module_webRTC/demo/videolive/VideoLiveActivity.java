...
public class VideoLiveActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.anubis.module_webRTC.R.layout.activity_video_live);
        ...
        vPaintPlayer = (StarWhitePanel) findViewById(com.anubis.module_webRTC.R.id.painter);
        vPanelBtn = findViewById(com.anubis.module_webRTC.R.id.panel_btn);
        vCleanBtn = findViewById(com.anubis.module_webRTC.R.id.clean_btn);
