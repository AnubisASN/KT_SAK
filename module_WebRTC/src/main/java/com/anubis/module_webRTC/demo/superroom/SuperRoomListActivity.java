...
public class SuperRoomListActivity extends BaseActivity implements AdapterView.OnItemClickListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.anubis.module_webRTC.R.layout.activity_super_room_list);
        ((TextView)findViewById(com.anubis.module_webRTC.R.id.title_text)).setText("对讲机房间列表");
